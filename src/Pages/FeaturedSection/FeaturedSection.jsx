  ...
  return (
    <div className="grid grid-cols-4">
      ...
      <div>
        ...
        <p>
          Easily host your own events to support social causes, raise awareness,
          or build local impact.
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          "Stay in control with simple tools for organizing successful events."
        </p>
      </div>
      <div>
        <h2>Update or Delete Events</h2>
        <p>Need to make changes? Update event info or remove events anytime.</p>
        <p>
